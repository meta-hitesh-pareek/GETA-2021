...
public final class Sparse {
	...
	public Sparse(int count,Integer [][] matrix){
	...
	public boolean isSymmetrical(){
		...
		Integer[][] transposeMatrix = Sparse.formMatrix(this.transpose(), this.rows, this.columns);
		Integer[][] matrix = Sparse.formMatrix(this.getSparseMatrix(),this.rows, this.columns);
	...
	public static void main(String [] args){
		...
		Sparse m = new Sparse(8,sparseMatrix);
